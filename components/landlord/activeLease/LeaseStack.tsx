                        ...
                        <div className="mt-2 space-y-1.5">
                            ...
                            {isActive && (
                                <div className="flex gap-2">
                                    <button
                                        onClick={() => onPrimary(lease)}
                                        className="flex-1 inline-flex items-center justify-center gap-1.5 px-3 py-1.5 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg text-xs font-semibold shadow-sm"
                                    >
                                        View Details <ArrowRight className="w-3 h-3" />
                                    </button>
                                    <button
                                        onClick={() => onKyp(lease)}
                                        className="inline-flex items-center justify-center px-3 py-1.5 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white rounded-lg text-xs font-semibold shadow-sm"
                                    >
