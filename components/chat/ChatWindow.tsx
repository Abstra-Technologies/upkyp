...
export default function ChatWindow({
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0 bg-white relative w-full">
      <div className="flex-shrink-0 flex items-center gap-2 md:gap-3 px-3 md:px-4 py-2.5 md:py-3 bg-white border-b border-gray-200 z-50">
        <button
          onClick={onBack}
        ...
        <div className="flex items-center gap-2 md:gap-3 flex-1 min-w-0">
          <img
            src={selectedChat.profilePicture || "https://res.cloudinary.com/dptmeluy0/image/upload/v1764120619/Portrait_Placeholder_hexdd5.png"}
        ...
        <button className="p-2 hover:bg-gray-100 active:bg-gray-200 rounded-full transition-colors flex-shrink-0">
          <MoreVertical className="w-5 h-5 text-gray-500" />
        </button>
      </div>

      <div className="flex-1 overflow-y-auto overscroll-contain px-3 md:px-4 py-3 md:py-4 bg-gradient-to-b from-gray-50 to-white">
        {messages.length === 0 ? (
                  ...
                  {msgs.map((msg, i) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`
                            max-w-[85%] md:max-w-[80%] px-3 md:px-4 py-2 md:py-2.5 rounded-2xl
                            ${
                              isOwn
