...
const Page_footer = () => {
  const socialLinks = [
    ...
    { icon: FaLinkedinIn, href: "https://www.linkedin.com/company/abstra-technologies-corporation" },
  ];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12">
        ...
        <div className="flex flex-col items-center text-center mb-8 sm:mb-12">
          ...
          <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
            <Link
              href="/"
              className="text-2xl sm:text-4xl font-bold select-none hover:scale-105 transition-transform duration-200"
            >
              Upkyp
            </Link>
          ...
          <p className="text-white/90 text-xs sm:text-sm max-w-md leading-relaxed mb-4 sm:mb-6 px-2">
            ...
            {socialLinks.map((social, index) => {
              ...
              return (
                <Link
                  ...
                  className="w-8 h-8 sm:w-10 sm:h-10 bg-white/10 hover:bg-white/20 rounded-lg flex items-center justify-center transition-all duration-200 hover:scale-110 border border-white/20 backdrop-blur-sm"
                >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-8 text-center sm:text-left mb-8 sm:mb-0">
          {/* Product */}
          <div>
            <h3 className="text-[11px] sm:text-sm font-semibold uppercase tracking-wider mb-2 sm:mb-3">
              Product
            </h3>
          ...
          <div>
            ...
            <div className="text-white/80 text-xs sm:text-sm space-y-1 sm:space-y-2 leading-relaxed">

              <p className="break-all">support@upkyp.com
              </p>
        ...
        <div className="border-t border-white/20 mt-8 sm:mt-12 pt-4 sm:pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-left gap-3 sm:gap-6">
            {/* Left Section */}
            <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4">
              ...
              <div className="flex items-center gap-2">
                <div className="bg-white rounded-full p-1 flex items-center justify-center">
                  ...
                  {/*  src="https://res.cloudinary.com/dptmeluy0/image/upload/v1776576592/upkyp_stack_qrnjuy.png"*/}
                  {/*  alt="Kanso Labs"*/}
                  {/*  className="h-3.5 sm:h-5 w-auto opacity-80 hover:opacity-100 transition-opacity duration-150"*/}
                  {/*/>*/}
                </div>

                <span className="text-white/60 text-xs sm:text-sm">
                  Myojin Information Technology Solutions
                </span>
              </div>
            </div>
