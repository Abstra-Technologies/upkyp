...
import { useInbox, type Announcement, type Notification } from "@/hooks/tenant/useInbox";
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                                {announcement.photos.map((photo, index) => (
                                    <button
                                        key={index}
                                        onClick={() =>
                                            onImageClick(announcement.photos!, index)
                                        }
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <div className="flex items-center justify-between gap-2">
                            <span className="text-xs text-gray-600">
                                {paginatedItems.length} item
                                {paginatedItems.length !== 1 ? "s" : ""}
                            </span>
                            <div className="flex items-center gap-2">
                                {unreadCount > 0 && (
                                    <button
                    ...
                    <div className="bg-white rounded-lg border border-gray-200 p-3 sm:p-4 mb-20 sm:mb-4">
                        <div className="flex flex-col gap-3">
                            <div className="text-xs sm:text-sm text-gray-600 text-center">
                                ...
                                to{" "}
                                <span className="font-semibold text-gray-900">
                                    {Math.min(endIndex, notifications.length + announcements.length)}
                                </span>{" "}
                                of{" "}
                                <span className="font-semibold text-gray-900">
                                    {notifications.length + announcements.length}
