...
export default function PropertyVerificationDetails() {
    ...
    useEffect(() => {
        if (property_id) {
            fetch(`/api/systemadmin/property-verifications/${property_id}`)
                .then((res) => res.json())
                .then((data) => {
    ...
    const handleVerification = async (status) => {
        ...
        try {
            const res = await fetch(
                "/api/systemadmin/property-verifications/update-status",
                {
                    method: "POST",
                    headers: {
            ...
            if (res.ok) {
                ...
                router.push("/system_admin/property_verification");
            } else {
            ...
            <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                        The requested property verification could not be located.
                    </p>
                    <button
                        onClick={() => router.push("/system_admin/property_verification")}
                            ...
                            <div className="px-6 py-4 space-y-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-900">
                                        ...
                                        {property?.brgy_district && `${property.brgy_district}, `}
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-gray-200">
                            ...
                            <div className="px-6 py-4 space-y-4">
                                <div>
                                    ...
                                    <p className="text-sm text-gray-900">
                                        {getDocTypeLabel(verification.doc_type)}
                                    </p>
                                </div>
                                {verification.tin_number && (
                                    <div>
                                        <label className="text-sm font-medium text-gray-500 flex items-center gap-1">
                                            <Hash size={14} />
                                            TIN Number
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-900">
                                        {verification.reviewed_by || "Not yet reviewed"}
                                    </p>
                                </div>
                                <div>
                                    <label className="text-sm font-medium text-gray-500 flex items-center gap-1">
                                ...
                                <div className="max-w-2xl mx-auto">
                                    <div className="relative group">
                                        {imageLoading ? (
                                            ...
                                            <div className="w-full h-96 bg-gray-100 rounded-lg border border-gray-200 flex flex-col items-center justify-center text-gray-500">
                                            ...
                                            <img
                                                src={verification.submitted_doc}
                                                alt="Submitted Document"
                                                className="w-full h-96 object-contain rounded-lg border border-gray-200 cursor-pointer transition-transform group-hover:scale-[1.02]"
                                                onClick={() =>
                                                    openImageModal(
                                                        verification.submitted_doc,
                                                        getDocTypeLabel(verification.doc_type)
                                                    )
                                                }
                                    ...
                                    <button
                                        ...
                                        className="w-full mt-4 flex items-center justify-center gap-2 px-3 py-2 text-sm font-medium text-blue-600 bg-blue-50 hover:bg-blue-100 disabled:bg-gray-100 disabled:text-gray-400 disabled:cursor-not-allowed rounded-lg transition-colors"
                                    >
                                        <Eye size={16} />
                                        View Full Size
                                    </button>
