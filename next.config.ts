        ...
        headers: [
...

          {
            ...
            value: [
              ...
              // ✅ API / WS (UNCHANGED)
              "connect-src 'self' https://*.openstreetmap.org https://*.tile.openstreetmap.org https://www.google-analytics.com https://analytics.google.com https://www.googletagmanager.com https://*.supabase.co wss://*.supabase.co https://upkyp-chat.onrender.com wss://upkyp-chat.onrender.com http://localhost:3000 ws://localhost:3000 https://www.google.com https://upkyp.vercel.app https://upkyp.com",
              "font-src 'self' data:",
